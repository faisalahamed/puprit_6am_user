...
import 'package:medibott/data/model/response/place_details_model.dart';
import 'package:medibott/data/model/response/prediction_model.dart';
import 'package:medibott/data/model/response/response_model.dart';
import 'package:medibott/data/model/response/zone_response_model.dart';
...
import 'package:medibott/view/base/confirmation_dialog.dart';
...
import 'package:medibott/view/screens/location/widget/module_dialog.dart';
import 'package:medibott/view/screens/location/widget/permission_dialog.dart';
  ...
  Future<ResponseModel> addAddress(
    ...
    if (response.statusCode == 200) {
      if (fromCheckout &&
          !getUserAddress()
              .zoneIds
              .contains(response.body['zone_id'].toString())) {
        responseModel = ResponseModel(
            false,
